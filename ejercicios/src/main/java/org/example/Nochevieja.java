 ...
 * @deprecated Método principal que ejecuta el programa lee las horas y calcula los minutos restantes hasta medianoche para cada hora introducida
 */
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (minutosquequedan != -1) {
                System.out.println(minutosquequedan+ " minutos");
            } else {
