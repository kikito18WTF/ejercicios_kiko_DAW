...
//copiar una palabra
 ...
 public void bingo(){
        ...
        Integer vector[] = new Integer[bolas];
        int num_aleatorio = 0;
        ...
        for (int i = 0; i < vector.length; i++) {
            ...
            }while(Arrays.asList(vector).contains(num_aleatorio));  //a) y b) crear vector comprobando repetidos
        ...
        System.out.println(bolas + " bolas extraídas hasta ahora: " + Arrays.toString(vector));
